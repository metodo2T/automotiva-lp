        ...
        <div className="grid lg:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="bg-brand-blue text-white p-8 rounded-3xl shadow-2xl relative overflow-hidden flex flex-col justify-between group">
                ...
                <div className="mt-10 relative z-10">
                     <a href="https://wa.me/message/G2ACCQQEZMBHK1" className="flex items-center justify-between w-full text-center bg-brand-orange text-brand-blue font-bold py-4 px-6 rounded-xl hover:bg-white hover:text-brand-blue transition-all duration-300 shadow-lg group-hover:translate-y-[-2px]">
